  ...
  const renderDetail = () => {
    ...
    return (
      <div className="h-full flex flex-col">
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 right-0 glass border-t border-white/10 px-4 pb-6 pt-2 h-24 flex items-center justify-around z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <button 
